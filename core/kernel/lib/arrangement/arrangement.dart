...
final class Arrangement {
  ...
  factory Arrangement.of(Bundle bundle) {
...
Vec2 _outwardTangent(Bundle b, Coedge u) {
  var c = b.edgeCubic(u.edge, space: .root);
...
Arrangement _computeArrangement(Bundle bundle) {
  ...
  for (final contour in contours) {
    ...
    final probe = bundle.edgeCubic(first.edge, space: .root).point(0.5);
