...
extension type const CellHandle._(int raw) implements Object {
  ...
  CellId id(TopologyBundle bundle) => bundle.cellId(this);
  CellKey key(TopologyBundle bundle) => bundle.key(this);
  CellView view(TopologyBundle bundle) => CellView._((bundle, this));
}
...
extension type const FrameHandle._(CellHandle h) implements CellHandle {
  ...
  CellId id(TopologyBundle bundle) => bundle.frameId(this);
  CellKey key(TopologyBundle bundle) => bundle.frameKey(this);
  FrameView view(TopologyBundle bundle) => ._((bundle, this));
}
...
extension type const VertexHandle._(CellHandle h) implements CellHandle {
  ...
  CellId id(TopologyBundle bundle) => bundle.vertexId(this);
  CellKey key(TopologyBundle bundle) => bundle.vertexKey(this);
  VertexView view(TopologyBundle bundle) => ._((bundle, this));
}
...
extension type const EdgeHandle._(CellHandle h) implements CellHandle {
  ...
  CellId id(TopologyBundle bundle) => bundle.edgeId(this);
  CellKey key(TopologyBundle bundle) => bundle.edgeKey(this);
  EdgeView view(TopologyBundle bundle) => ._((bundle, this));
}
...
extension type const FaceHandle._(CellHandle h) implements CellHandle {
  ...
  CellId id(TopologyBundle bundle) => bundle.faceId(this);
  CellKey key(TopologyBundle bundle) => bundle.faceKey(this);
  FaceView view(TopologyBundle bundle) => ._((bundle, this));
}
