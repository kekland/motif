...
final class Scene with ChangeNotifier {
  ...
  Ref<H>? refOf<H extends CellHandle>(CellKey<H> cell) => cells.refOf(cell);
  CellKey<H> keyOf<H extends CellHandle>(Ref<H> ref) => cells.keyOf(ref) as CellKey<H>;
  H? handleOf<H extends CellHandle>(Ref<H> ref) => bundle.handle(cells.keyOf(ref)!) as H?;
