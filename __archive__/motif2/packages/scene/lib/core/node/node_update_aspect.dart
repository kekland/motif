...
extension type const NodeUpdateAspect(int value) {
  ...
  /// Node's shape has changed.
  static const shape = NodeUpdateAspect(16);

  /// Node's transform has changed.
  static const transform = NodeUpdateAspect(32);

  /// Node's transient transform has changed.
  static const transientTransform = NodeUpdateAspect(64);

  /// Node's paint property has changed.
  static const paint = NodeUpdateAspect(128);
  ...
  static const layout = NodeUpdateAspect(2 | 4 | 8 | 16 | 32 | 64);

  /// Any aspect of the node has changed.
  static const all = NodeUpdateAspect(1 | 2 | 4 | 8 | 16 | 32 | 64 | 128);
  ...
  bool get hasShape => contains(.shape);
