...
FFI_BIND(flutter_texture_registry_get, WGPUPluginGlobals_getTextureRegistry, flutter_texture_registry_t) {
  return WGPUPluginGlobals_getTextureRegistry_ptr();
}
...
void darwin_ffi_init() {
  FFI_RESOLVE(WGPUPluginGlobals_getTextureRegistry);
