...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    final libDir = root.resolve('build/lib/$platformDir/Release/');
    ...
    final inkLib = 'ink_stroke_modeler';
    final inkLibFilePath = libDir.resolve('lib$inkLib.a');
    if (!File.fromUri(inkLibFilePath).existsSync()) {
      throw Exception('libink_stroke_modeler.a not found: $inkLibFilePath');
    }
    ...
    final builder = CBuilder.library(
      ...
      assetName: 'ink_stroke_modeler.dart',
      language: .cpp,
    ...
    output.dependencies.add(inkLibFilePath);
