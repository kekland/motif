...
class PortalProxyNavigator<T> extends Navigator {
  const PortalProxyNavigator({
    super.key,
    required this.child,
    required this.onPop,
  }) : super(
  ...
  @override
  NavigatorState createState() => PortalProxyNavigatorState();
}

class PortalProxyNavigatorState extends NavigatorState {
  ...
  @override
  PortalProxyNavigator get widget => super.widget as PortalProxyNavigator;
