...
external void darwin_ffi_init();

@ffi.Native<flutter_texture_registry_t Function()>()
external flutter_texture_registry_t flutter_texture_registry_get();

@ffi.Native<ffi.Int64 Function(flutter_texture_registry_t, flutter_texture_t)>()
external int flutter_texture_registry_register(
  flutter_texture_registry_t registry,
  flutter_texture_t texture,
);

@ffi.Native<ffi.Void Function(flutter_texture_registry_t, ffi.Int64)>()
external void flutter_texture_registry_texture_frame_available(
  flutter_texture_registry_t registry,
  int texture_id,
);

@ffi.Native<ffi.Void Function(flutter_texture_registry_t, ffi.Int64)>()
external void flutter_texture_registry_unregister_texture(
  flutter_texture_registry_t registry,
  int texture_id,
);

@ffi.Native<mtl_flutter_texture_t Function()>()
external mtl_flutter_texture_t mtl_flutter_texture_create();

@ffi.Native<ffi.Void Function(mtl_flutter_texture_t)>()
external void mtl_flutter_texture_destroy(
  mtl_flutter_texture_t texture,
);

@ffi.Native<ffi.Void Function(mtl_flutter_texture_t, mtl_texture_t)>()
external void mtl_flutter_texture_update_buffer(
  mtl_flutter_texture_t texture,
  mtl_texture_t mtl_texture$1,
);
...
final class flutter_texture_registry extends ffi.Opaque {}

typedef flutter_texture_registry_t = ffi.Pointer<flutter_texture_registry>;

final class flutter_texture extends ffi.Opaque {}

typedef flutter_texture_t = ffi.Pointer<flutter_texture>;

final class mtl_flutter_texture extends ffi.Opaque {}

typedef mtl_flutter_texture_t = ffi.Pointer<mtl_flutter_texture>;

final class mtl_texture extends ffi.Opaque {}

typedef mtl_texture_t = ffi.Pointer<mtl_texture>;
