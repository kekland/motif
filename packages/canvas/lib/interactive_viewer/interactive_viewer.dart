...
class _InteractiveViewerState extends State<InteractiveViewer> with TickerProviderStateMixin {
  ...
  Matrix4 _matrixTranslate(Matrix4 matrix, Offset translation) {
    ...
    final Matrix4 nextMatrix = matrix.clone()..translateByDouble(alignedTranslation.dx, alignedTranslation.dy, 0, 1);
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    switch (_gestureType!) {
      case _GestureType.scale:
        ...
        // final rescaledScale = math.pow(details.scale, 2.0);
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
      ...
      child: GestureDetector(
        ...
        supportedDevices: {PointerDeviceKind.trackpad, PointerDeviceKind.touch},
...
class _InteractiveViewerBuilt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget child = KeyedSubtree(key: childKey, child: this.child);
